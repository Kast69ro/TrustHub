...
import softclub from '@/assets/soft.png'
import omuz from '@/assets/omuz.png'
...
export function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="relative flex h-[500px] w-full items-center justify-center overflow-hidden p-25"
      ref={containerRef}
    >
      <div className="flex size-full max-h-[210px] max-w-[900px] flex-col items-stretch justify-between gap-10">
