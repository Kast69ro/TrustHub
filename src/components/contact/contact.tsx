...
export default function Contact() {
  ...
  return (
    <Box sx={{ bgcolor: "#f9f7f3", minHeight: "100vh", py: 8, px: { xs: 2, md: 4 } }}>
      <Box maxWidth="1200px" mx="auto">
        <Box textAlign="center" mb={10}>
          <Typography variant="h3" component="h1" fontFamily="serif" fontWeight="bold" color="#1a1a1a" gutterBottom>
            Get in Touch
          </Typography>
        ...
        <Stack direction={{ xs: "column", md: "row" }} spacing={6} alignItems="flex-start">
              ...
              <Card key={idx} sx={{ boxShadow: 2, borderRadius: 2 }}>
                <CardContent>
                  <Stack direction="row" spacing={3} alignItems="center" mb={2}>
                    <Box sx={{ bgcolor: "#d7c4a3", p: 1.5, borderRadius: 2, display: "flex", alignItems: "center", justifyContent: "center" }}>
                      {icon}
                    </Box>
                    <Box>
          ...
          <Stack flex={2} spacing={2}>
            <Card sx={{ boxShadow: 3, borderRadius: 2, p: "8px" }}>
              <CardHeader
                title={
        ...
        <Box mt={12}>
          <Card sx={{ boxShadow: 3, borderRadius: 2 }}>
            <CardHeader
              title={
                <Typography variant="h5" fontWeight="bold" color="#1a1a1a" align="center">
